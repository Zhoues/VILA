...
export BASE_RUN_NAME="MapAnything-traj-align-all"
...
export DATA_MIXTURE="DROID_w_image+DROID_w_image_intrinsics+DROID_w_image_intrinsics_and_depth+ShareRobot_w_image+ca1m_traj_w_image+ca1m_traj_w_image_intrinsics+ca1m_traj_w_image_intrinsics_and_depth+agibot_traj_w_image+agibot_traj_w_image_intrinsics"
