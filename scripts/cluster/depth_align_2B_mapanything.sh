...
export BASE_RUN_NAME="MapAnything-3d-align-partial"
...
# export DATA_MIXTURE="ca1m_reasoning_template_qa_3_2M_split+ca1m_reasoning_template_qa_3_2M_split_w_intrinsics+ca1m_reasoning_template_qa_3_2M_split_w_intrinsics_and_depth"
# export DATA_MIXTURE="ca1m_template_qa_split+ca1m_template_qa_split_w_intrinsics+ca1m_template_qa_split_w_intrinsics_and_depth"
export DATA_MIXTURE="ScanNet_w_image+ScanNet_w_image_intrinsics+ScanNet_w_image_intrinsics_and_depth+ca1m_template_qa_split+ca1m_template_qa_split_w_intrinsics+ca1m_template_qa_split_w_intrinsics_and_depth+DROID_w_image+DROID_w_image_intrinsics+DROID_w_image_intrinsics_and_depth+ShareRobot_w_image+ca1m_traj_w_image+ca1m_traj_w_image_intrinsics+ca1m_traj_w_image_intrinsics_and_depth+agibot_traj_w_image+agibot_traj_w_image_intrinsics+ca1m_vacant_qa+ca1m_vacant_qa_intrinsics+ca1m_vacant_qa_intrinsics_and_depth"
