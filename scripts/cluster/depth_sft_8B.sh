...
export BASE_RUN_NAME="depth-sft-new_placement+new_simulator-8-nodes-new"
export STAGE_PATH=/share/project/zhouenshen/hpfs/code/VILA/runs/train/NVILA-8B-depth-align-new_placement+new_simulator-8-nodes/model
