...
# export DATA_MIXTURE="choice_qa_4M+reason_template_qa_5_9M+sat_176k+ca1m_reasoning_template_qa_3_2M_split+ca1m_choice_qa_2_1M_split+ca1m_visual_choice_qa_341k+refcoco_1_2M+refcocop_1_2M+refcocog_80k+embspatial_127k+ca1m_vacant_qa_231k+ca1m_vacant_qa_231k+ca1m_multi_view_qa_77k+simulator_216k+blink_spatial_relation+embspatial_12k_random"
