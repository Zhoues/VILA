...
DEFAULT_RUN_NAME="mapanything-geo-align"
DEFAULT_GLOBAL_TRAIN_BATCH_SIZE=32
DEFAULT_GRADIENT_ACCUMULATION_STEPS=2

STAGE_PATH=${1:-"/share/project/zhouenshen/hpfs/code/VILA/runs/train/NVILA-Lite-8B-MapAnything"}
...
OUTPUT_DIR=${3:-"runs/train/NVILA-Lite-8B-MapAnything-geo-align"}
