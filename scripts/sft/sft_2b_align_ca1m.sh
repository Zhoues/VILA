...
DEFAULT_RUN_NAME="mapanything-reason-template-qa-geo-align"
...
export DATA_MIXTURE="reason_template_qa"

export WANDB_MODE=offline

TIMESTAMP=$(date +"%Y%m%d_%H%M%S")

OUTPUT_DIR=${3:-"runs/train/NVILA-Lite-2B-MapAnything-reason-template-qa-geo-align"}
