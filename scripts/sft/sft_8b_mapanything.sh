...
DEFAULT_RUN_NAME="mapanything-geo-sft"
DEFAULT_GLOBAL_TRAIN_BATCH_SIZE=32
DEFAULT_GRADIENT_ACCUMULATION_STEPS=2

STAGE_PATH=${1:-"/share/project/zhouenshen/hpfs/code/VILA/runs/train/NVILA-Lite-8B-MapAnything-geo-align/model"}
...
# export DATA_MIXTURE="ScanNet_w_image+ScanNet_w_image_RGB+ScanNet_w_image_intrinsics+ScanNet_w_image_intrinsics_and_depth+ca1m_template_qa_split+ca1m_template_qa_split_RGB+ca1m_template_qa_split_w_intrinsics+ca1m_template_qa_split_w_intrinsics_and_depth"
...
OUTPUT_DIR=${3:-"runs/train/NVILA-Lite-8B-MapAnything-geo-sft"}
