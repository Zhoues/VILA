...
DEFAULT_RUN_NAME="depth-sft-metric-factor-new"
DEFAULT_GLOBAL_TRAIN_BATCH_SIZE=7
DEFAULT_GRADIENT_ACCUMULATION_STEPS=1

STAGE_PATH=${1:-"/share/project/zhouenshen/hpfs/code/VILA/runs/train/NVILA-Lite-2B-moge"}
...
export DATA_MIXTURE="sat_metric_factor_test+sat_metric_factor_test_RGB"
export WANDB_MODE=offline

TIMESTAMP=$(date +"%Y%m%d_%H%M%S")

OUTPUT_DIR=${3:-"runs/train/NVILA-Lite-2B-moge-sft"}
...
torchrun \
    ...
    llava/train/train_mem.py \
        ...
        --spatial_tower /share/project/zhouenshen/hpfs/ckpt/MoGe/moge-2-vitl-normal \
