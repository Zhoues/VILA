...
DEFAULT_GLOBAL_TRAIN_BATCH_SIZE=5
DEFAULT_GRADIENT_ACCUMULATION_STEPS=1

STAGE_PATH=${1:-"/share/project/zhouenshen/hpfs/code/VILA/runs/train/NVILA-Lite-2B-moge-sft-new/model"}
...
export DATA_MIXTURE="ca1m_vacant_qa_231k"
# export DATA_MIXTURE="sat_metric_factor_test"
export WANDB_MODE=offline

TIMESTAMP=$(date +"%Y%m%d_%H%M%S")

OUTPUT_DIR=${3:-"runs/train/NVILA-Lite-2B-moge-sft-more-new"}
